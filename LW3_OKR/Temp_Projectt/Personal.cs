...
namespace LW3_OKR
{
    ...
    {
        private readonly IMongoCollection<Personal> personalCollection;

        public MongoDBPersonal(IMongoCollection<Personal> mockCollection)
        {
            personalCollection = mockCollection;
        }
